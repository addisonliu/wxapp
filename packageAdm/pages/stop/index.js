...
Page({
  ...
  getBaseData() {
    let that = this;
    util.request(api.plant,{empNo: app.globalData.userInfo,site: app.globalData.site}).then(function(res){
      console.log(res.result)
      if(res.result !=='P5'){
        wx.showModal({
              title: '提示',
              content: res.result + '厂别暂不支持此功能.',
    ...
    // util.request(api.stop, {empNo: 'K1111X62', site: 'WKS'  })
    .then(function (res) {
